                    ...
                    754: (e,t,n)=>{
                        ...
                        function u(e) {
                            ...
                            i && (t.protocol = i[1].toLowerCase(),
                                ...
                                e = e.substring(n.lastIndex);
                                const s = r.indexOf("@");
                                -1 !== s && (r = r.substring(s + 1)),
                                    t.host = r;
                                const o = r.lastIndexOf(":");
                                -1 !== o && (t.port = r.substring(o + 1),
                                    r = r.substring(0, o)),
                                    t.hostname = r
                            }
                            if (n = new RegExp("^([^?#]*)","gi"),
                        ...
                        function g(e) {
                            ...
                            !r || !n.pathname.endsWith("/") && n.pathname.endsWith(`/${r}`) || (i.endsWith("/") || (i += "/"),
                                i += r),
                                n.pathname = i;
                            const {jwt: s} = e;
                            if (s) {
                            ...
                            constructor() {
                                ...
                                this.postis = function(e) {
                                    ...
                                    var u = {
                                        ...
                                        send: function(e) {
                                            var t = e.method;
                                            (l || e.method === d) && i && "function" == typeof i.postMessage ? i.postMessage(JSON.stringify({
                                                postis: !0,
                                                scope: n,
                                                method: t,
                                                params: e.params
                                        ...
                                        destroy: function(e) {
                                            clearInterval(t),
                                                l = !1,
                                            r && "function" == typeof r.removeEventListener && r.removeEventListener("message", h),
                                            e && e()
                                        }
                                    }
                    ...
                    571: (e,t)=>{
                        ...
                        t.parse = function(e) {
                            const i = "object" == typeof (arguments.length <= 1 ? void 0 : arguments[1]) && (arguments.length <= 1 ? void 0 : arguments[1])
                                ...
                                , o = JSON.parse(e, r);
                            return "ignore" === s.protoAction ? o : o && "object" == typeof o && e.match(n) ? (t.scan(o, s),
                                o) : o
                        }
                            ,
                            t.scan = function(e) {
                        ...
                        r.prototype.stringify = function(e) {
                            ...
                            r.prototype.formatLogMessage = function(e) {
                                for (var t = "", n = 1, r = arguments.length; n < r; n++) {
                                    var s = arguments[n];
                                    !this.stringifyObjects && e !== i.levels.ERROR || "object" != typeof s || (s = this.stringify(s)),
                                        t += s,
                                    n !== r - 1 && (t += " ")
                                }
                    ...
                    7: e=>{
                        ...
                        function r() {
                            ...
                            if (!n || n.length < 3)
                                return e;
                            var i = null;
                            return n[3] && (i = n[3].match(/\s*at\s*(.+?)\s*\((\S*)\s*:(\d*)\s*:(\d*)\)/)),
                                !i || i.length <= 4 ? (0 === n[2].indexOf("log@") ? e.methodName = n[3].substr(0, n[3].indexOf("@")) : e.methodName = n[2].substr(0, n[2].indexOf("@")),
                                    e) : (e.methodName = i[1],
                                    e.fileLocation = i[2],
                                    e.line = i[3],
                                    e.column = i[4],
                        ...
                        function s() {
                            ...
                            if (!(t[s] < e.level))
                                for (var a = !(e.options.disableCallerInfo || i.disableCallerInfo) && r(), c = n.concat(e.transports), l = 0; l < c.length; l++) {
                                    var d = c[l]
                                        , h = d[s];
                                    if (h && "function" == typeof h) {
                                        ...
                                        e.id && u.push("[" + e.id + "]"),
                                        a && a.methodName.length > 1 && u.push("<" + a.methodName + ">: ");
                                        var p = u.concat(o);
                                        h.bind(d).apply(d, p)
                                    }
                                }
                    ...
                    620: e=>{
                        ...
                        function l(e, t, n, i) {
                            ...
                            void 0 === o)
                                o = s[t] = n,
                                    ++e._eventsCount;
                            else if ("function" == typeof o ? o = s[t] = i ? [n, o] : [o, n] : i ? o.unshift(n) : o.push(n),
